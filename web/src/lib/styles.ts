...
const CATEGORY_STYLES: Record<TechStackCategory, BadgeStyle> = {
  language: {
    label: "Language",
    className:
      "bg-blue-500/12 text-blue-600 dark:text-blue-300 border-blue-500/25",
  },
  framework: {
    label: "Framework",
    className:
  ...
  library: {
    label: "Library",
    className:
      "bg-indigo-500/12 text-indigo-600 dark:text-indigo-300 border-indigo-500/25",
  },
  database: {
    label: "Database",
    className:
  ...
  tooling: {
    label: "Tooling",
    className:
      "bg-cyan-500/12 text-cyan-600 dark:text-cyan-300 border-cyan-500/25",
  },
  platform: {
    label: "Platform",
    className:
  ...
  protocol: {
    label: "Protocol",
    className:
      "bg-fuchsia-500/12 text-fuchsia-600 dark:text-fuchsia-300 border-fuchsia-500/25",
  },
  other: {
    label: "Other",
    className:
      "bg-slate-500/12 text-slate-600 dark:text-slate-300 border-slate-500/25",
  },
};
...
const ACTIVITY_STYLES: Record<RecentActivity, BadgeStyle> = {
  ...
  dormant: {
    label: "Dormant",
    className:
      "bg-slate-500/12 text-slate-500 dark:text-slate-400 border-slate-500/25",
  },
};
...
const KIND_STYLES: Record<GraphNodeKind, KindStyle> = {
  ...
  "external-package": {
    ...
    color: "#22c55e",
    className:
      "bg-green-500/12 text-green-600 dark:text-green-300 border-green-500/25",
  },
  service: {
    label: "Service",
    color: "#06b6d4",
  ...
  datastore: {
    ...
    color: "#a855f7",
    className:
      "bg-purple-500/12 text-purple-600 dark:text-purple-300 border-purple-500/25",
  },
  "external-service": {
    label: "External service",
    color: "#ec4899",
    className:
      "bg-pink-500/12 text-pink-600 dark:text-pink-300 border-pink-500/25",
  },
  other: {
    label: "Other",
    color: "#94a3b8",
